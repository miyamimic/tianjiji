// Fengling AI Gacha Simulator Engine (v2)
// Complete JS mechanical layer: Probability, Spark Pity, Click Rhythm Parser, Sound FX, Configuration Manager
...
export interface GachaCard {
  ...
  description: string;
  featured?: boolean;
  char_evaluation_pool?: string[];
  char_touch_lines?: string[];
}
...
// ============================================================================
// Default Pool Configuration (Default preset with rich card art & dialogues)
// ============================================================================
...
export const DEFAULT_GACHA_POOL: GachaPoolConfig = {
  ...
  spark_reward: {
    card_id: 'card_ssr_01',
    description: '13抽内必得限定UP角色【夜蔷薇·莉莉丝】（井机制）',
  },
  rates: {
    SSR: 0.03,
    SR: 0.15,
  ...
  cards: [
    {
      ...
      featured: true,
      char_evaluation_pool: [
        '哇……天哪！！真的是她？！金光闪闪的限定UP！',
        '出了出了！！手气今天简直爆棚！我没让你失望吧～',
        '……不会吧，竟然真的一发入魂抽到夜蔷薇了？！',
        '快看！这金光！我的手今天绝对被幸运女神亲吻过～',
      ],
      char_touch_lines: [
        '手感好好……感觉限定的气息已经扑面而来了～',
        '这张卡牌的花纹……有种神秘的引力。',
    ...
    },
    {
      ...
      featured: false,
      char_evaluation_pool: [
        '是星辰咏者！虽然不是当期UP，但这可是纯正SSR啊！',
        '哇！金光再度绽放！塞莱斯蒂的声音超治愈的～',
        '歪了个漂亮的常驻大姐姐，完全不亏！',
      ],
      char_touch_lines: [
        '星光在指尖流淌的感觉……好神奇。',
